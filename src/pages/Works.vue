...
<template>
  <div class="works_page">
    <div class="header_section">
      ...
      <SliderImages :slides="currentImages" v-model="isModalProjects"></SliderImages>
      <div class="project_list">
        <div v-for="project in works" class="project_item">
          <Button
            class="link"
            :typeElement="project.typeShow === 'link' ? 'link' : 'button'"
            :target="project.typeShow === 'link' ? 'blank' : ''"
            :href="project.typeShow && project?.typeShow === 'link' ? project?.link : ''"
